const dataToSend = {
  ...
  fetch('../codigo/apitableservicios.php', {
    method: 'POST',
    headers: {
    ...
    function eliminarFila(button) {
      ...
      const dataToSend = {
        idp_servicios: row.cells[0].innerText
      };
      
      fetch('../codigo/apiEliminarServicios.php', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
        ...
        filas.forEach((fila, indice) => {
          ...
          if (celda) { // Verificar si la celda es válida antes de acceder a su contenido
            ...
            if (valor === 'Pendiente') {
              ...
              fetch('../codigo/apiInsertarServicios.php', {
                method: 'POST',
                headers: {
                  'Content-Type': 'application/json',
                },
