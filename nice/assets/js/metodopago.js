const dataToSend = {
  ...
  fetch('../codigo/apitablemetodopago.php', {
    method: 'POST',
    headers: {
    ...
    function eliminarFila(button) {
      ...
      const dataToSend = {
        idp_metodopago: row.cells[0].innerText
      };
      
      fetch('../codigo/apiEliminarmetodopago.php', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
        ...
        filas.forEach((fila, indice) => {
          ...
          if (celda) { // Verificar si la celda es válida antes de acceder a su contenido
            ...
            if (valor === 'Pendiente') {
              ...
              fetch('../codigo/apiInsertarmetodopago.php', {
                method: 'POST',
                headers: {
                  'Content-Type': 'application/json',
                },
